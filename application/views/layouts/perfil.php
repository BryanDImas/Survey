...
<div class="container-fluid">
    ...
    <div class="row" style="position: relative;">
        <div class="col-12">
            <div class=""><img src="<?= base_url('assets/images/background/profile-bg.jpg') ?>" width="100%" height="150"></div>
            <div class="card">
                <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-6">
                                                <label for="first_name">
                                                    <h4 class="text-themecolor">Nombre Comercial:</h4>
                                                </label><br>
                                                <label for="">
                                                    <h6><?= $empresa->NombreComercial ?></h6>
                                                </label>
                                            </div>
                                            <div class="form-group">
                                                <div class="col-xs-6">
                                                    <label for="last_name">
                                                        <h4 class="text-themecolor">Dirección Empresarial:</h4>
                                                    </label><br>
                                                    <label for="">
                                                        <h6><?= $empresa->DireccionFisica ?></h6>
                                                    </label>
                                                </div>
                                                <div class="form-group">
                                                    <div class="col-xs-6">
                                                        <label for="last_name">
                                                            <h4 class="text-themecolor">Correo Empresarial:</h4>
                                                        </label><br>
                                                        <label for="">
                                                            <h6><?= $empresa->Correo ?></h6>
                                                        </label>
                                                    </div>
                                                    <div class="form-group">
                                                        <div class="col-xs-6">
                                                            <label for="last_name">
                                                                <h4 class="text-themecolor">Teléfono Empresarial:</h4>
                                                            </label><br>
                                                            <label for="">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-xs-6">
                                                                <label for="last_name">
                                                                    <h4 class="text-themecolor">Sector Economico:</h4>
                                                                </label><br>
                                                                <label for="">
                                                                    <h6><?= $empresa->SectorEconomico ?></h6>
                                                                </label>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col-xs-6">
                                                                    <label for="last_name">
                                                                        <h4 class="text-themecolor">Descripcion de la empresa:</h4>
                                                                    </label><br>
                                                                    <label for="">
                                                                        <h6><?= $empresa->DescripcionEmpresa ?></h6>
                                                                    </label>
                                                                </div>
                                                            </div>
                                                        </div>
