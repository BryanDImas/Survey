                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?= base_url() ?>principal/registro2" method="post" class="form-control-line" enctype="multipart/form-data">
                                    <div class="row">
                                            ...
                                            <div class="card">
                                                <div class="form-group has-success">
                                                    ...
                                                    <p>
                                                        ...
                                                        <input name="propietario" type="text" class="form-control form-control-line" />
                                                    </p>
                                                    <p>
                                                        <label class="form-control-label">Representante legal:</label>
                                                        <input name="representante" type="text" class="form-control form-control-line" />
                                                    </p>
                                                    <p>
